...
// import { Button } from "@/component/ui/Button"; // ตรวจสอบ path ให้ถูกต้อง
            ...
            <main className="flex-grow py-6 px-4 flex items-center justify-center">
                <div className="w-full max-w-md">
                    <Card className="w-full p-8 shadow-xl bg-white border-2 border-orange-200 bg-opacity-90 backdrop-blur-sm rounded-2xl">
                        ...
                        <div className="space-y-6">
                                <Link href="/rooms/create" className="w-full block">
                                    {/* เปลี่ยนเป็นใช้ variant="three-d" */}
                                ...
                                <Link href="/rooms/roomCode/join" className="w-full block">
                                    {/* เปลี่ยนเป็นใช้ variant="three-d" แต่ปรับสีให้แตกต่างจากปุ่มแรก */}
                                    <Button  className="w-full">
                                        <div className="flex items-center justify-center">
                                            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                            ...
                            <div className="pt-4 border-t border-orange-100">
                                <div className="flex items-center justify-center space-x-4">
                                    <div className="flex items-center text-amber-700">
                                        ...
                                        <svg className="flex items-center text-amber-700 w-5 h-5 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                                        </svg>
                                        <span className="text-sm">หลายเมนูให้เลือก</span>
